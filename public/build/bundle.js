...
var app = (function () {
    ...
    */ const requestAnimFrame = function() {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div2 = element("div");
    			img1 = element("img");
    			attr_dev(h10, "class", "displayText svelte-11iht20");
    			add_location(h10, file$1, 88, 6, 3342);
    			attr_dev(div0, "class", "display svelte-11iht20");
    			add_location(div0, file$1, 87, 4, 3313);
    			if (!src_url_equal(img0.src, img0_src_value = "pointer.svg")) attr_dev(img0, "src", img0_src_value);
    			attr_dev(img0, "alt", "");
    			attr_dev(img0, "id", "dial1");
    			attr_dev(img0, "class", "pointer svelte-11iht20");
    			add_location(img0, file$1, 91, 6, 3434);
    			attr_dev(figure, "id", "pointer-container");
    			attr_dev(figure, "class", "svelte-11iht20");
    			add_location(figure, file$1, 90, 4, 3395);
    			attr_dev(h11, "class", "displayText svelte-11iht20");
    			add_location(h11, file$1, 94, 6, 3538);
    			attr_dev(div1, "class", "display svelte-11iht20");
    			add_location(div1, file$1, 93, 4, 3509);
    			if (!src_url_equal(img1.src, img1_src_value = "pointer.svg")) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "alt", "");
    			attr_dev(img1, "id", "dial2");
    			attr_dev(img1, "class", "pointer svelte-11iht20");
    			add_location(img1, file$1, 97, 6, 3627);
    			attr_dev(div2, "id", "pointer-container");
    			attr_dev(div2, "class", "svelte-11iht20");
    			add_location(div2, file$1, 96, 4, 3591);
    			attr_dev(div3, "class", "container svelte-11iht20");
    			add_location(div3, file$1, 86, 2, 3284);
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*val1*/ 1) set_data_dev(t0, /*val1*/ ctx[0]);
    			if (dirty & /*val2*/ 2) set_data_dev(t3, /*val2*/ ctx[1]);
    		},
    		i: noop$1,
    		o: noop$1,
    ...
    function instance$1($$self, $$props, $$invalidate) {
    		...
    		function rotateDial(e) {
    			...
    			if (dialNumber == 1) {
    				...
    				if (degrees > 240 || degrees < 120) {
    					...
    					$$invalidate(0, val1 = Math.round(map(degrees, 240, 360 + 120, 0, val1Max)));
    				}
    			}
    			...
    			if (dialNumber == 2) {
    				...
    				if (degrees > 240 || degrees < 120) {
    					...
    					$$invalidate(1, val2 = Math.round(map(degrees, 240, 360 + 120, 0, val2Max)));
    				}
    			}
    		}
    	...
    	$$self.$capture_state = () => ({ val1Max, val2Max, val1, val2 });

    	$$self.$inject_state = $$props => {
    		if ('val1Max' in $$props) val1Max = $$props.val1Max;
    		if ('val2Max' in $$props) val2Max = $$props.val2Max;
    		if ('val1' in $$props) $$invalidate(0, val1 = $$props.val1);
    		if ('val2' in $$props) $$invalidate(1, val2 = $$props.val2);
    	};
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(canvas, file, 103, 0, 2236);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('prev2' in $$props) prev2 = $$props.prev2;
    	};
